...
<h3 align="center">轻松在 GitHub 或个人简历中展示你的技能！</h3>
<hr>

<h3 align="center">由 Cloudflare Workers ⚡ 驱动</h3>

<h3>注意：为保证图标风格一致并确保浏览器兼容性，我们不接受针对添加图标的 Pull Request。如需新增图标，请提交 Issue。<h3>
...
- [主题图标](#themed-icons)
- [每行显示图标数量](#icons-per-line)
- [居中对齐图标](#centering-icons)
- [图标列表](#icons-list)
...
将下方的代码块复制并粘贴到你的 README.md 文件中，即可添加技能图标组件！

将 `?i=js,html,css` 修改为你自己的技能列表，多个技能之间用英文逗号 `,` 分隔！你可以在[这里](#icons-list)找到完整的图标列表。
...
部分图标支持深色和浅色背景。你可以通过 URL 参数指定所需的主题。

此为可选配置，默认主题为深色（dark）。

将 `&theme=light` 替换为 `dark` 或 `light`。主题指的是背景颜色，浅色主题的图标背景为白色，而深色主题则为黑色（或深灰色）。
...
你可以指定每一行显示的图标数量！这是一个可选参数，默认为 15。

将 `&perline=3` 修改为 1 到 50 之间的任意数字。
...
想在 README 中将图标居中显示吗？这些 SVG 图片会自动调整大小，因此你可以使用常规的图片居中方式来实现。
...
以下是目前支持的所有图标列表。欢迎提交 Issue 建议添加新图标！
...
非常感谢你使用我的项目！如果你愿意更进一步，支持我的开源工作，可以请我喝杯咖啡：

<a href='https://ko-fi.com/Q5Q860KQ2' target='_blank'><img height='36' style='border:0px;height:36px;' src='https://cdn.ko-fi.com/cdn/kofi1.png?v=3' border='0' alt='Buy Me a Coffee at ko-fi.com' /></a>

你也可以通过提交 Issue 建议图标，或直接提交 Pull Request 来直接支持本项目！