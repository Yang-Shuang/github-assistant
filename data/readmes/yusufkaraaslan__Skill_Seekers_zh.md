...
英文 | [简体中文](README.zh-CN.md) | [日本語](README.ja.md) | [한국어](README.ko.md) | [Español](README.es.md) | [Français](README.fr.md) | [Deutsch](README.de.md) | [Português](README.pt-BR.md) | [Türkçe](README.tr.md) | [العربية](README.ar.md) | [हिन्दी](README.hi.md) | [Русский](README.ru.md)
...
**🧠 AI 系统的数据层。** Skill Seekers 将文档网站、GitHub 仓库、PDF、视频、笔记本、维基以及 10 多种其他类型的源，转化为结构化的知识资产——在几分钟内即可为 AI Skills（Claude、Gemini、OpenAI）、RAG 管道（LangChain、LlamaIndex、Pinecone）和 AI 编程助手（Cursor、Windsurf、Cline）提供动力，而非数小时。

> 🌐 **[访问 SkillSeekersWeb.com](https://skillseekersweb.com/)** - 浏览 20+ 预设配置，分享你的配置，并查阅完整文档！

> 📋 **[查看开发路线图与任务](https://github.com/users/yusufkaraaslan/projects/2)** - 涵盖 10 个类别的 134 项任务，任选一项参与贡献！

## 🌐 生态系统

Skill Seekers 是一个多仓库项目。以下是各组件的存放位置：
...
**Skill Seekers 是通用的预处理层**，位于原始文档与所有消费它的 AI 系统之间。无论你是构建 Claude skills、LangChain RAG 管道，还是 Cursor `.cursorrules` 文件——数据准备流程完全一致。你只需操作一次，即可导出到所有目标平台。
...
Skill Seekers 是 **AI 系统的数据层**。它将 18 种数据源——文档网站、GitHub 仓库、PDF、视频、Jupyter Notebooks、Word/EPUB/AsciiDoc 文档、OpenAPI 规范、PowerPoint 演示文稿、RSS 订阅、手册页、Confluence 维基、Notion 页面、Slack/Discord 导出等——转化为面向所有 AI 目标的结构化知识资产：
