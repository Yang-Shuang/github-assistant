...
<p align="center"><strong>📦 新地址：</strong>Agent Squad 已迁移！该项目此前托管于 <strong>awslabs/agent-squad</strong>，现由 <strong>2fastlabs/agent-squad</strong> 维护。<br>请相应更新你的书签、克隆 URL 和依赖项。</p>
