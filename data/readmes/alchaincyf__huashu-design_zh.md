...
**对你的 Agent 说一句话即可 —— Claude Code、Cursor、Codex、OpenClaw、Hermes 均可使用。**

<br>

只需 3 到 30 分钟，你即可交付 **产品发布动画**、可点击的 App 原型、可编辑的 PPT 演示文稿或印刷级信息图。

不是“勉强能用”的 AI 质量 —— 它看起来就像真的人类设计团队做的。将你的品牌资产（Logo、配色、UI 截图）交给该 Skill，它会读取并匹配品牌的调性；即使什么都不给，内置的 20 套设计规范也能让你避开 AI 生成的廉价感。

**本 README 中的每一个动画均由 Huashu Design 自身生成。** 无需 Figma，无需 After Effects —— 只需一句话 + 运行 Skill。下次产品发布需要宣传视频？你也能自己制作。

```
npx skills add alchaincyf/huashu-design
```

> 📣 **现已采用 MIT 协议。** 自 2026-05-14 起，该 Skill 完全开源并遵循 [MIT 许可证](LICENSE) —— 个人使用与商业使用均免费，无需授权。([变更详情](#license))

[查看演示](#demo-gallery) · [安装指南](#install) · [功能说明](#what-it-does) · [核心机制](#core-mechanics) · [对比 Claude Design](#vs-claude-design)

> 📖 **致中文读者**：该 Skill 由花叔（@AlchainHust）开发。一句话即可让 Agent 在 3–30 分钟内交付**产品发布动画 / 可点击 App 原型 / 可编辑 PPT / 印刷级信息图**。完整中文介绍见 [README.zh.md](README.zh.md)。
...
<p align="center"><sub>▲ Huashu Design 的核心功能演示（10秒主视觉动画，<a href="https://github.com/alchaincyf/huashu-design/releases/download/v2.0/hero-animation-v10-en.mp4">下载 MP4</a>）</sub></p>
...
**无需按钮、面板或 Figma 插件。完全兼容各类 Agent** —— 可无缝接入 Claude Code、Cursor、Trae、Hermes、OpenClaw，或任何支持 Markdown Skill 的 Agent。
...
> 📖 **演示均为英文并行版本**。中文版默认文件名见 [中文说明文档](README.zh.md)。
