...
- **星群（Constellation）**：将任务分解为可执行的 DAG
- **动态 DAG 编辑**：支持工作流的自适应演进
- **异步执行**：具备并行任务协调能力
- **统一 AIP 协议**：保障智能体间的安全通信
...
### <img src="assets/ufo_blue.png" alt="UFO² logo" width="30" style="vertical-align: -5px;"> **UFO² 桌面端 AgentOS**
