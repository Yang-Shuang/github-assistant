...
> [!IMPORTANT]
> :rocket: Gateway 2.0（预发布版）Portkey 的核心企业级网关已随 2.0 版本合并至开源。你可以在此处尝试预发布分支 [here](https://github.com/portkey-ai/gateway/tree/2.0.0)。
> 了解更多关于 Portkey 未来的计划，请查看我们的 [**A 轮融资公告**](https://portkey.wiki/rohit-a)。


<div align="center">

🆕 **[Portkey Models](https://github.com/Portkey-AI/models)** - 涵盖 40+ 提供商、2300+ 模型的开源大语言模型（LLM）定价数据库。[探索 →](https://portkey.ai/models)


# AI Gateway
#### 通过一个快速、友好的 API 接入 250+ 大语言模型
...
[**AI Gateway**](https://portkey.wiki/gh-10) 专为快速、可靠且安全地路由到 1600+ 语言、视觉、音频和图像模型而设计。它是一个轻量级、开源且面向企业级的解决方案，让你能在 2 分钟内接入任意大语言模型。

- [x] **极速响应**（延迟 <1ms），体积小巧（仅 122KB）
- [x] **历经实战检验**，每日处理超过 100 亿 token
- [x] **面向企业级应用**，提供增强的安全性、可扩展性及自定义部署能力

<br>

#### 使用 AI Gateway 你可以做什么？
- 2 分钟内接入任意大语言模型 - [快速入门](#quickstart-2-mins)
- 通过 **[自动重试（Automatic Retries）](https://portkey.wiki/gh-11)** 和 **[故障转移（Fallbacks）](https://portkey.wiki/gh-12)** 防止服务中断
- 借助 **[负载均衡（Load Balancing）](https://portkey.wiki/gh-13)** 和 **[条件路由（Conditional Routing）](https://portkey.wiki/gh-14)** 扩展 AI 应用规模
- 通过 **[护栏机制（Guardrails）](https://portkey.wiki/gh-15)** 保护你的 AI 部署安全
- 突破文本限制，支持 **[多模态能力（Multi-modal Capabilities）](https://portkey.wiki/gh-16)**
- 探索 **[智能体工作流（Agentic Workflow）](https://portkey.wiki/gh-17)** 集成方案
- 使用 **[MCP Gateway](https://portkey.ai/docs/product/mcp-gateway)** 管理 MCP 服务器，支持企业级认证与可观测性

<br><br>

> [!TIP]
> ⭐ Star 本仓库将帮助更多开发者发现 AI Gateway 🙏🏻
>
...
```
<div align="center">
<img src="https://portkey.ai/blog/content/images/size/w1600/2024/11/image-15.png" width=600 title="Request flow through Portkey's AI gateway with retries and guardrails" alt="请求通过 Portkey AI Gateway 的流程（含重试与护栏机制）"/>
</div>
