...
**一款多模型 AI Agent 桌面客户端** —— 接入任意 AI 服务商，通过 MCP 与 Skills 扩展功能，用手机远程控制，让你的助手学习并适应你的工作流。
...
**中文：** CodePilot 的 Runtime / Harness / macOS UI 大重构已进入预览测试阶段。如果你愿意协助测试，请使用最新预览包，请勿使用旧的 `0.53` / `0.54` 构建版本。我们尤其欢迎反馈 P0/P1 级问题：安装或启动失败、Settings（设置）页面卡死加载、Claude Code / Codex / Native Runtime 无法发送消息、模型或服务商异常、升级后旧数据丢失、macOS 菜单栏图标异常，以及通知或打包相关问题。稳定版仍可作为日常使用版本。
...
Or visit the [Releases（发布页）](https://github.com/op7418/CodePilot/releases) page for all versions.
