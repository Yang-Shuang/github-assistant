...
<p align="center">开源的 Looker 替代方案。</p>
...
<br>
<p align="center">
    <a href="http://www.lightdash.com"><b>官网</b></a> •
    <a href="https://www.loom.com/share/c0805a236a994de397ac5142fdfe4b7f"><b>观看演示</b></a> •
    <a href="http://docs.lightdash.com/"><b>文档</b></a> •
    <a href="https://join.slack.com/t/lightdash-community/shared_invite/zt-2wgtavou8-VRhwXI%7EQbjCAHQs0WBac3w"><b>加入 Slack 社区</b></a>
</p>
<div align="center">
...
### 让公司里的每个人都能用数据回答自己的问题

连接你的 dbt 项目 --> 在 dbt 中添加指标（metrics） --> 与团队分享洞察

欢迎加入我们的团队，[我们正在招聘](https://lightdash.notion.site/Lightdash-Job-Board-a2c7d872794b45deb7b76ad68701d750)。

</div>

## 功能特性：

- [x] 🙏 熟悉的界面，让用户使用预定义指标进行自助式数据分析
- [x] 👩‍💻 在与你的 dbt 项目相同的目录下，通过 YAML 文件声明维度（dimensions）和指标
- [x] 🤖 自动从你的 dbt 模型中创建维度
- [x] 📖 为你的用户同步 dbt 描述和元数据（metadata）
- [x] 🔍 轻松访问图表的底层记录，并支持数据下钻（drill-down）功能
- [x] 🧮 表格计算让你可以即时深入挖掘数据
- [x] 🕵️‍♀️ 血缘（Lineage）功能让你能够查看模型的上游和下游依赖关系
- [x] 📊 为指标提供全面且直观的数据可视化库
- [x] 👷‍♂️ 保存图表并构建仪表盘（dashboard），与团队分享你的洞察
- [x] 💻 强大的开发者体验，包括预览 BI 环境以及通过 CI/CD 进行自动化内容验证
- [x] 🔄 探索所有图表的版本历史，并可在任意时间点回滚
- [x] 🚀 通过 URL 轻松分享你的工作，或通过 Slack/邮件安排定期推送

缺少什么功能？请查看我们的[开放议题](https://github.com/lightdash/lightdash/issues)，看看是否已有相关需求（如果有的话请点个 👍）。否则，我们非常欢迎[提交新议题](https://github.com/lightdash/lightdash/issues/new/choose)来描述你的需求 😊

## 演示

体验我们的 [演示应用](https://demo.lightdash.com)!

## 快速开始

### 从 Lightdash Cloud 开始

你可以通过[注册 Lightdash Cloud 免费试用](https://app.lightdash.cloud/register)来避免自行托管和配置 Lightdash 的繁琐工作。有关定价的更多详情[请在此查看](https://www.lightdash.com/pricing)。

### 一键部署

在 [Render](https://render.com) 上免费使用一键功能部署 Lightdash。
...
按照我们的 [Kubernetes 指南](https://docs.lightdash.com/self-host/self-host-lightdash)，使用我们的[社区 Helm Charts](https://github.com/lightdash/helm-charts) 将 Lightdash 部署到生产环境。


## 入门步骤

Step 1 - ⚡️ [自托管 Lightdash（可选）](https://docs.lightdash.com/self-host/self-host-lightdash)

Step 2 - 🔌 [连接项目](https://docs.lightdash.com/get-started/setup-lightdash/connect-project)

Step 3 - 👩‍💻 [创建你的第一个指标](https://docs.lightdash.com/get-started/setup-lightdash/intro-metrics-dimensions)

## 社区支持

📣 如果你需要更多支持，请[前往我们的 Slack 社区](https://join.slack.com/t/lightdash-community/shared_invite/zt-2wgtavou8-VRhwXI%7EQbjCAHQs0WBac3w)，在那里你可以直接与 Lightdash 团队以及其他优秀的社区成员交流。我们很乐意与你探讨功能需求、实施细节或 dbt 技巧，当然也包括表情包和 SQL 笑话！

你还可以通过关注以下平台来了解 Lightdash 的最新动态：
...
我们允许你在 dbt 项目中直接定义指标和维度，将所有业务逻辑集中在一个地方，从而增强数据分析的上下文关联。

再也不用纠结总营收（total revenue）的四个不同值中哪个才是**正确**的那个了（你以后会感谢我们的 😉）。

### 🤝 **建立对数据的信任。**

我们希望公司里的每个人都能感受到数据是值得信赖的。那么，为什么不**展示**给他们看呢？

我们将你期望的数据质量上下文信息直接引入你的 BI 工具中，让人们清楚地知道可以放心使用这些数据。

### 🧱 **提供有意义的构建模块，让用户自主回答数据问题。**

使用 Lightdash，你可以把 SQL 留给专家。我们为数据团队提供了所需的工具，以便构建所有人都能使用的指标和维度。

这样，业务部门的任何人都可以组合、细分和筛选这些指标与维度，从而自主解答自己的问题。

### 📖 **开源，现在且永远**

**Lightdash 由我们的社区共建，为社区服务。**

我们认为一个 BI 工具应该是价格亲民、可配置且安全的——而开源特性让我们能够同时实现这三点 🙂

### 🤑 **经济实惠的分析方案**

喜欢 Looker，但不喜欢它的价格标签吗？

通过 Lightdash，我们提供免费的自托管服务（全都是开源的！），或者如果你想要轻松的分析设置，也可以选择价格实惠的云服务平台。

## 文档

对某个功能有疑问？或者想随便读点轻松的内容？请前往我们的 [Lightdash 文档](https://docs.lightdash.com/)，查看教程、参考文档、常见问题解答等。

## 报告 Bug 与提交需求

想报告 Bug 或请求新功能？请提交一个[议题](https://github.com/lightdash/lightdash/issues/new/choose)。

## 本地开发与贡献

我们欢迎任何形式的贡献，大小不拘。查看[我们的指南](https://github.com/lightdash/lightdash/blob/main/.github/CONTRIBUTING.md#contributing-to-lightdash)了解如何开始。

请参阅我们在本地开发 Lightdash 的[说明文档](https://github.com/lightdash/lightdash/blob/main/.github/CONTRIBUTING.md#setup-development-environment)。

## 贡献者 ✨

感谢这些了不起的人做出的贡献（[表情符号索引](https://allcontributors.org/docs/en/emoji-key)）：
