...
![Codex](https://img.shields.io/badge/Codex-v0.135.0-orange.svg)
...
> ⭐ 小白能入门 | 开发者能提效 | 团队负责人能建规范 | 企业和高校能做培训
...
这是一套**系统化、小白可入门、团队可落地**的 AI Coding 与 Agent 工作流中文教程，覆盖三类代表性工具：
...
- **👶 分层友好**：零基础看路线图，开发者看实操，团队负责人看规范和安全
- **💻 实战导向**：1500+ 个代码块、命令片段、配置模板和提示词示例，边学边练
- **📊 质量保证**：关键版本号与 CLI 行为优先对照 **官方 Release / 文档** 修订；细节仍可能随上游快速变化，请以你本机版本为准
- **🔄 持续更新**：适配最新稳定版（Claude Code v2.1.158 / OpenClaw 稳定版 v2026.5.27 / Codex CLI v0.135.0，实际以 GitHub Releases 和本机 `codex --version` 为准）
...
| 你是谁 | 先解决什么问题 | 推荐入口 |
|--------|----------------|----------|
| **零基础小白** | 看懂概念，跑起第一个 AI 工具 | README 快速开始 → Claude Code 01 / OpenClaw OC-03 / Codex CX-01 |
...
- **Codex CLI**：CLI v0.135.0 对照官方 Release；安装可用 OpenAI 官方 install script、Windows PowerShell install script、npm、Homebrew 或 GitHub Release 二进制包，实际以 [Codex CLI 文档](https://developers.openai.com/codex/cli) 为准
...
| **Claude Code版本** | 2.1.158（2026-05-30 验证） |
| **OpenClaw版本** | 稳定版 **v2026.5.27**（2026-05-30 对照 [Releases](https://github.com/openclaw/openclaw/releases)）；v2026.5.28 为 beta，v2026.5.29-alpha.1 仅见 tag，预发布请自行取舍 |
| **Codex版本** | CLI v0.135.0（2026-05-29 GitHub Release）；v0.136.0-alpha.1 为预发布；实际以 `codex --version`、App 更新日志与 [GitHub](https://github.com/openai/codex) 为准 |
...
| 产品 | 当前验证版本 | 本轮复核 | 官方来源 |
|------|-------------|---------|---------|
| Claude Code | v2.1.158 | 2026-05-30 | [GitHub Releases](https://github.com/anthropics/claude-code/releases) |
| OpenClaw | 稳定版 v2026.5.27 | 2026-05-30 | [GitHub Releases](https://github.com/openclaw/openclaw/releases) |
| Codex CLI | v0.135.0 | 2026-05-30 | [GitHub Releases](https://github.com/openai/codex) |
...
- Claude Code 教程基于 **v2.1.158** 编写（[Release](https://github.com/anthropics/claude-code/releases/tag/v2.1.158)）；OpenClaw 教程以 **稳定版 v2026.5.27** 为修订参考；Codex 教程按 **Codex CLI v0.135.0 与 2026-05 OpenAI 官方 Codex 文档** 修订，CLI/App 版本以本机和官方 Releases 为准
