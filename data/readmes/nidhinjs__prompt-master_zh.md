...
一个 Claude 技能，用于为任何 AI 工具编写精准提示词。零 Token 或积分浪费。完整保留上下文与记忆。不再需要反复重试才能得到第一次就该得到的答案。

**兼容：** Claude, ChatGPT, Gemini, o1/o3, MiniMax, Cursor, Claude Code, GitHub Copilot, Windsurf, Bolt, v0, Lovable, Devin, Perplexity, Midjourney, DALL-E, Stable Diffusion, ComfyUI, Sora, Runway, ElevenLabs, Zapier, Make，以及你投入使用的任何 AI 工具。
