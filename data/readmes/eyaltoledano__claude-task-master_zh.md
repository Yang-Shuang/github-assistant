...
<p align="center">
<b>Taskmaster</b>: 面向 AI 驱动开发的任务管理系统，旨在与任意 AI 聊天工具无缝协作。
</p>
...
<p align="center">
  ...
  <a href="https://tryhamster.com/docs/taskmaster" target="_blank">文档</a>
</p>
...
面向 Claude 的 AI 驱动开发的任务管理系统，专为与 Cursor AI 无缝协作而设计。

## Documentation

📚 **[查看完整文档](https://tryhamster.com/docs/taskmaster)**

### Quick Links

- [快速入门指南](https://tryhamster.com/docs/taskmaster/getting-started/quick-start/quick-start)
- [安装说明](https://tryhamster.com/docs/taskmaster/getting-started/quick-start/installation)
- [API 密钥与提供商](https://tryhamster.com/docs/taskmaster/getting-started/api-keys)
- [支持的编辑器](https://tryhamster.com/docs/taskmaster/ide-setup/supported-editors)
- [MCP 工具参考](https://tryhamster.com/docs/taskmaster/capabilities/mcp)
- [CLI 命令参考](https://tryhamster.com/docs/taskmaster/capabilities/cli-root-commands)
- [任务结构](https://tryhamster.com/docs/taskmaster/capabilities/task-structure)
- [任务依赖关系](https://tryhamster.com/docs/taskmaster/task-workflow/dependencies)
- [标签与工作流](https://tryhamster.com/docs/taskmaster/task-workflow/tags)
- [研究命令](https://tryhamster.com/docs/taskmaster/task-workflow/research)
- [循环命令](https://tryhamster.com/docs/taskmaster/automation/loop)
- [AI 提供商概览](https://tryhamster.com/docs/taskmaster/ai-providers/overview)
- [团队协作](https://tryhamster.com/docs/taskmaster/team/overview)
- [最佳实践](https://tryhamster.com/docs/taskmaster/best-practices/index)
- [常见问题解答](https://tryhamster.com/docs/taskmaster/getting-started/faq)
- [更新日志](CHANGELOG.md)

### More from Hamster

- [Hamster Studio](https://tryhamster.com/product/studio)
- [产品与工程方法](https://tryhamster.com/methods)
- [产品与工程技能](https://tryhamster.com/skills)
- [Hamster 定价](https://tryhamster.com/pricing)
...
> **Note:** 点击链接后，你仍需在配置中添加 API 密钥。该链接会安装带有占位符密钥的 MCP 服务器，你需要将其替换为实际的 API 密钥。
...
MCP（模型控制协议）允许你直接在编辑器中运行 Taskmaster。
