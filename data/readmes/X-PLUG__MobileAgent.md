...
❗️We provide the Mobile-Agent-v3.5 API on <img src="./assets/aliyun.png" width="14px" style="display:inline;">Bailian for quick experience. View the [documentation](https://bailian.console.aliyun.com/cn-beijing?tab=model#/model-market/detail/gui-plus-2026-02-26).
...
## 📢News
- [2026.5.12] 🔥🔥🔥 **ToolCUA** is released! An end-to-end Computer Use Agent for **optimal GUI-Tool path orchestration**, featuring a 2-stage training pipeline (trajectory-aware tool synthesis → Online Agentic RL) to master when to use GUI actions, invoke tools, and switch between them. See [HuggingFace](https://huggingface.co/papers/2605.12481) for the paper and model weights. [Github](https://github.com/X-PLUG/ToolCUA).
...
- `[2026.3.19]`🔥🔥 The **GUI-Owl-1.5** series models are now available for online inference. Please refer to the [<img src="./assets/aliyun.png" width="14px" style="display:inline;"> **Alibaba Cloud Bailian**](https://bailian.console.aliyun.com/cn-beijing?tab=model#/model-market/detail/gui-plus-2026-02-26), and [<img src="./assets/tongyi.png" width="14px" style="display:inline;"> **Modelscope API-Inference**](https://modelscope.cn/models/iic/GUI-Owl-1.5-8B-Think).
