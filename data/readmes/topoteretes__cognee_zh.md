<div align="center">
  ...
  <p align="center">
  <a href="https://www.youtube.com/watch?v=8hmqS2Y5RVQ&t=13s">演示</a>
  .
  <a href="https://docs.cognee.ai/">文档</a>
  .
  <a href="https://cognee.ai">了解更多</a>
  ·
  <a href="https://discord.gg/NQPKmU5CCg">加入 Discord</a>
  ·
  <a href="https://www.reddit.com/r/AIMemory/">加入 r/AIMemory</a>
  .
  <a href="https://github.com/topoteretes/cognee-community">社区插件与扩展</a>
  </p>
...
Cognee 为 AI Agent（智能体）提供共享且持续优化的记忆系统，用于存储你的数据、决策和工作流，使其能够结合上下文进行回忆、关联与行动。
...
Cognee 是一款面向 AI Agent（智能体）的开源记忆控制平面，支持以任意格式或结构摄入数据，并持续学习以提供精准的上下文。它融合了嵌入向量（embeddings）、图数据库与认知科学方法，使你的文档不仅能按语义进行检索，还能在动态变化中保持关联。



:star: _帮助我们触达更多开发者并壮大 cognee 社区。给本仓库点个 Star！_

:books: _请查阅详细的 [documentation](https://docs.cognee.ai/getting-started/installation#environment-configuration) 文档以获取安装与配置指南。_

:crab: _可作为插件接入你的 OpenClaw —— [cognee-openclaw](https://www.npmjs.com/package/@cognee/cognee-openclaw)_

✴️ _可作为插件接入你的 Claude Code —— [claude-code-plugin](https://github.com/topoteretes/cognee-integrations/tree/main/integrations/claude-code)_



### Why use Cognee:

- 轻松构建企业大脑——整合多源数据，为 Agent（智能体）注入领域专业知识
- 知识基础设施——统一摄入、图/向量检索、本地运行、本体对齐、多模态支持
- 持久化与自学习 Agent——从反馈中学习、上下文管理、跨智能体知识共享
- 可靠且可信的 Agent——Agent 级用户/租户隔离、可追溯性、OTEL 收集器支持、审计特性
...
了解更多，[请查看这篇简短的端到端 Colab 教程](https://colab.research.google.com/drive/12Vi9zID-M3fpKpKiaqDBvkk98ElkRPWy?usp=sharing)，了解 Cognee 的核心功能。
