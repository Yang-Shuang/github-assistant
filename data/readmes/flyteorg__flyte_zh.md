...
> ## Flyte 2 Devbox 现已可用！
>
> 请查看[此处](https://www.union.ai/docs/v2/flyte/user-guide/run-modes/running-devbox/)的指南以快速上手。
>
> 寻找 Flyte 1？请访问 [master](https://github.com/flyteorg/flyte/tree/master) 分支，Flyte 1 目前在此维护。

---

# Flyte 2

**以纯 Python 可靠地大规模编排机器学习（ML）流水线、模型与智能体。**
...
Flyte 是 [LF AI & Data Foundation](https://lfaidata.foundation/projects/flyte/) 的毕业项目。
