...
<p align="center"><b>编写 HTML。渲染视频。为智能体而生。</b></p>

<p align="center">
  <a href="https://hyperframes.heygen.com/quickstart">快速入门</a> |
  <a href="https://hyperframes.heygen.com/showcase">展示区</a> |
  <a href="https://www.hyperframes.dev/">在线体验</a> |
...
HyperFrames 是一个开源框架，可将 HTML、CSS、媒体文件和支持跳转的动画（seekable animation）转换为确定性的 MP4 视频。你可以通过本地 CLI 使用它，让具备 skills（技能）的 AI 编程智能体调用它，或将其作为托管创作工作流的渲染核心。
