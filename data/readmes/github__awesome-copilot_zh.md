...
由社区创建的资源合集，包含自定义智能体（agents）、指令（instructions）、技能（skills）、钩子（hooks）、工作流和插件，旨在全面提升你的 GitHub Copilot 使用体验。

> [!TIP]
> **在网站上浏览完整资源合集 →** [awesome-copilot.github.com](https://awesome-copilot.github.com)
>
> 该网站提供数百项资源的全局全文搜索与筛选功能，并设有 [工具](https://awesome-copilot.github.com/tools) 板块（涵盖 MCP 服务器及开发者工具）以及 [学习中心](https://awesome-copilot.github.com/learning-hub)（提供指南和教程）。
>
> **在 AI 智能体中使用本资源合集？** 我们提供了机器可读的 [`llms.txt`](https://awesome-copilot.github.com/llms.txt)，其中结构化列出了所有智能体、指令和技能。

## 📖 学习中心 (Learning Hub)

初次接触 GitHub Copilot 自定义功能？网站上的 **[学习中心](https://awesome-copilot.github.com/learning-hub)** 提供了精选文章、操作指南和参考资料——内容涵盖智能体（agents）、技能（skills）和指令（instructions）等核心概念，以及钩子（hooks）、智能体工作流、MCP 服务器和 Copilot 编程智能体的实操教程。

## 仓库内容

| 资源类型 | 说明 | 浏览 |
|----------|-------------|--------|
| 🤖 [Agents](docs/README.agents.md) | 集成 MCP 服务器的专用 Copilot 智能体 | [所有智能体 →](https://awesome-copilot.github.com/agents) |
| 📋 [Instructions](docs/README.instructions.md) | 按文件模式自动应用的编码规范 | [所有指令 →](https://awesome-copilot.github.com/instructions) |
| 🎯 [Skills](docs/README.skills.md) | 包含指令和内置资源的独立文件夹 | [所有技能 →](https://awesome-copilot.github.com/skills) |
| 🔌 [Plugins](docs/README.plugins.md) | 针对特定工作流精选的智能体与技能组合包 | [所有插件 →](https://awesome-copilot.github.com/plugins) |
| 🪝 [Hooks](docs/README.hooks.md) | 在 Copilot 智能体会话期间触发的自动化操作 | [所有钩子 →](https://awesome-copilot.github.com/hooks) |
| ⚡ [Agentic Workflows](docs/README.workflows.md) | 使用 Markdown 编写的 AI 赋能 GitHub Actions 自动化流程 | [所有工作流 →](https://awesome-copilot.github.com/workflows) |
| 🍳 [Cookbook](cookbook/README.md) | 开箱即用的 Copilot API 调用示例与配方 | — |

## 🛠️ 工具 (Tools)

想了解如何使用 Awesome Copilot？请查看网站上的 **[工具板块](https://awesome-copilot.github.com/tools)**，获取 MCP 服务器、编辑器集成及其他开发者工具，助你充分利用本资源合集。

## 安装插件

对于大多数用户，**Awesome Copilot** 市场已预注册在 Copilot CLI/VS Code 中，因此你可以直接安装插件：

```bash
copilot plugin install <plugin-name>@awesome-copilot
```

如果你使用的是较旧版本的 Copilot CLI 或自定义环境，并遇到“市场未知”的错误，请先注册一次该市场再进行安装：
...
请参阅 [CONTRIBUTING.md](CONTRIBUTING.md) · AI 智能体指南 ([AGENTS.md](AGENTS.md)) · 安全政策 ([SECURITY.md]) · 行为准则 ([CODE_OF_CONDUCT.md])

> 此处的自定义内容均来源于第三方开发者。安装前请仔细检查相关智能体及其文档。

## 贡献者 ✨ (Contributors)

感谢以下精彩的贡献者（[表情符号说明](./CONTRIBUTING.md#contributors-recognition)）：
...
- [VS Code Copilot 自定义文档](https://code.visualstudio.com/docs/copilot/copilot-customization) - 微软官方文档
- [GitHub Copilot 聊天功能文档](https://code.visualstudio.com/docs/copilot/chat/copilot-chat) - 完整的聊天功能指南
- [VS Code 设置](https://code.visualstudio.com/docs/getstarted/settings) - VS Code 通用配置指南

## ™️ 商标声明 (Trademarks)

本项目可能包含项目、产品或服务的商标或徽标。对 Microsoft 商标或徽标的授权使用须遵守并遵循 [Microsoft 的商标与品牌指南](https://www.microsoft.com/en-us/legal/intellectualproperty/trademarks/usage/general)。对本项目的修改版本中使用 Microsoft 商标或徽标不得引起混淆，也不得暗示 Microsoft 赞助。任何第三方商标或徽标的使用均受其各自政策约束。